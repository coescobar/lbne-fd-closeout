...
design, described in Section~\ref{sec_bars}, utilizes a coated acrylic waveguide coupled to
SiPMs. Alternate designs, desribed in the following sections, have
...
\begin{cdrfigure}[Connection between the PD twisted pair cable and
    SiPM mounting board.]{fig:5.8-2}{Connection between the PD twisted
    pair cable and SiPM mounting board.}
