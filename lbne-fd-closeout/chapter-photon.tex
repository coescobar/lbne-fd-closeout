...
\begin{figure}[h!]
  \centering
  \includegraphics[width=.4\columnwidth]{35t_map.jpg}
\caption[Probability of photon being detected in
  ...
  the photon detectors when depositing energy at map location. \fixme{(need
...
\begin{figure}[htb]
  \begin{center}
     \resizebox{.38\textwidth}{!}{\includegraphics[width=0.45\linewidth]{./figures/LSU_panel_drawing.png}}
     \resizebox{.58\textwidth}{!}{\includegraphics[width=0.8\linewidth]{./figures/LSU_panel_prototype.png}}
...
\begin{figure}[htb]
  \begin{center}
   \resizebox{.48\textwidth}{!}{\includegraphics[width=0.45\linewidth]{./figures/LSU_panel_prototype1_ly-position.png}}  
    \resizebox{.48\textwidth}{!}{\includegraphics[width=0.8\linewidth]{./figures/LSU_panel_prototype2_ly-position.png}}
...
\begin{figure}[htb]
  \begin{center}
   \resizebox{.48\textwidth}{!}{\includegraphics[width=0.45\linewidth]{./figures/LSU_panel_prototype_charge.png}}
   \resizebox{.48\textwidth}{!}{\includegraphics[width=0.8\linewidth]{./figures/LSU_panel_prototype_charge_zoom.png}}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=.3\columnwidth]{fig5-5-2.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=.6\columnwidth]{fig5-5-3.png}
...
As noted above, and shown in figure 5.5-4, a total of 10 PDs are
