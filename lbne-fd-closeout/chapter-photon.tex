...
\begin{cdrtable}[Individual photon collection efficiencies]{c | l | c | l}{example}
...
%
\begin{cdrtable}[Physics requirements for the photon detector electronics]{| l | l |}{fee_req}
