...
\begin{figure}[htb]
 \begin{center}
     \includegraphics[width=0.45\linewidth]{LSU_panel_drawing.png}
\includegraphics[width=0.45\linewidth]{LSU_panel_prototype.png}

%     \resizebox{.38\textwidth}{!}{\includegraphics[width=0.45\linewidth]{LSU_panel_drawing.png}}
%     \resizebox{.58\textwidth}{!}{\includegraphics[width=0.8\linewidth]{LSU_panel_prototype.png}}
...
%   \resizebox{.48\textwidth}{!}{\includegraphics[width=0.45\linewidth]{LSU_panel_prototype1_ly-position.png}}  
%    \resizebox{.48\textwidth}{!}{\includegraphics[width=0.8\linewidth]{LSU_panel_prototype2_ly-position.png}}
\caption[Light yield for the fiber LSU photon
  detection panels in response to a 1-in distant alpha source in
  LAr]{Light yield for the 3 (left) and 2 (right) fiber LSU photon
...
\caption[Summed charge plots of SiPMs in response to muon hodoscope trigger ]{Scatter plot of the summed charge of 3 SiPMs coupled to the
