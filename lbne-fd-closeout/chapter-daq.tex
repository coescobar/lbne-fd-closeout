...
useful frequency range \todo{say if it limits from above or below} to
...
The transfer of counter synchronization from the MTU containing the
...
\todo{Needs a bit of updating, some words here are out of date.}  The
