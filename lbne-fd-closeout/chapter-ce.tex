...
The Cold Digital Data ASIC (COLDATA) and its voltage regulators are mounted on the digital ASIC mezzanine.
...
\caption{Functional Block Diagram of the Cold Digital Data ASIC (COLDATA)}
