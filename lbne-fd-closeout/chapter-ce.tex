...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{elec_CMBpix1.pdf}
\includegraphics[width=\linewidth]{elec_CMBpix2.pdf}
\includegraphics[width=\linewidth]{elec_CMBpix3.pdf}
\caption{
  ...
  {\bf Middle:} The FPGA mezzanine, used in place of the COLDATA ASCI for the early set of tests.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4in]{elec_COLDATAfig.pdf}
