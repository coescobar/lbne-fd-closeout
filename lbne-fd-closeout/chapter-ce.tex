...
\newline rwh: I disagree about the intro sentence.  It's short and to the point as it is.
I am, of course, open to specific suggestions or offerings.
...
On second thought, I don't like the way it reads \& looks, so I took those back out.
FYI: Application-Specific Integrated Circuit (ASIC) and Complementary Metal-Oxide Semiconductor (CMOS)}

\fixme{This chapter needs a good illustration showing the placement of the electronics with respect to the APAs and the cryostat,
feedthroughs, etc.
\newline rwh: Done.}
\begin{cdrfigure}[The front end electronics as mounted on an APA]{elec_CMBonAPA}{The front end electronics as mounted on an APA.
  {\bf Top:} The front end electronics  is shown in the red ellipse.
