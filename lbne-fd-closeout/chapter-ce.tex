...
\fixme{automated placement and routing?
...
I did add hyphens, which make it less so.}
\fixme{This sentence is a mouthful -- not sure how the last phrase fits in (for design...)
...
\newline rwh: Sorry, I can't think of how to improve this without maybe adding a short lesson on the subject,
which I'm not really qualified to do, and besides I think that would exceed the scope of the CDR.
BTW, I added a sentence at the end, so your comment now refers to the next-to-last sentence.}
...
\fixme{for the LVDS connections? 
\newline rwh: LVDS is defined above.  Nothing to do with optical. Again, I'm not sure what you're asking here.}
\fixme{Here's what I understand: slower connections will use optical fiber, data will use copper. Is that right?
