...
location is adjacent to another LAr cryostat, the Liquid Argon Purity Demonstrator (LAPD)\cite{bib:lapdP07005}. This 
...
\begin{cdrfigure}[35T Layout in PC4]{35TLayout}{Drawing of arrangement of the 35T and LAPD in Proton Center beam line.}
  \includegraphics[width=1.0\textwidth]{35TLayout.png}
\end{cdrfigure}

Table~\ref{tab:35Tdimensions} gives the details of the construction materials and the dimensions for the 35T. More information can be found in\cite{bib:membcryo1573}.
...
LAPD has demonstrated that it is not necessary to evacuate a cryostat in order achieve LAr purity levels sufficient for LBNE. This is of paramount importance since the costs of multi-kiloton cryostats that could withstand evacuation is prohibitive. The 35T followed the procedure LAPD\cite{bib:lapdP07005} established to obtain and maintain pure LAr. 
