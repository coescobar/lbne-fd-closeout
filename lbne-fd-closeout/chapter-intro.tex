...
\fixme{Is this new or old? cite LBNE-docdb-9374 -- wire angle change request, 8981 and 9886,
 the tech board meeting documents -- trade study}
...
times.  Misassociating hits between views can result in %have the consequence of
...
\fixme{Is it necessary to go into the problems of the earlier design? I guess it's a way to describe the issue,
but seems like TMI}
...
design with this angle improves on the CD-1 \fixme{ditto} design in a number of
...
has been limited to $\sim$30~m on the advice of rock engineers. \fixme{No geotech investigation
at this site?} A
