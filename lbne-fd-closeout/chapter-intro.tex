...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Overview}
\begin{cdrfigure}[Underground detector illustration]{2x5kt-3d}{The LBNE underground liquid argon detector. Shown is the status of the detector design in January of 2015. The design consisted of two liquid argon detector module each with 5~kt fiducial volume.}
