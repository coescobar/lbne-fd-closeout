...
TPC panels, the staging platform for joining two panels, installation monorails \fixme{are these included in CF?} for moving the panels inside and outside of the cryostat, and a mobile scaffold for providing access to 
